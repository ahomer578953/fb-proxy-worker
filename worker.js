...
async function handleRequest(request) {
  ...
  modifiedHeaders.set('X-iorg-bsid', '@Magdi2051')
  modifiedHeaders.set('Proxy-Connection', 'keep-alive')
  ...
  try {
    ...
    return new Response('Error connecting to www.peddygist.com', { status: 502 })
  }
}
